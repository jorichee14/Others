...
| 2026-08-07 | write-up | Paper draft written (`paper/PAPER_DRAFT.md`): abstract, method (floor/instrument/4 diagnostics), results §4.1–4.6, deployment implications, limitations, reproducibility. Pending: citations, figures (floor-crossing matrix, P/R signature scatter, valley curves, burst dose-response), author list, venue formatting. |
