...
def _dbl(name: str) -> ParameterValue:
    ...
    interval_s:=30) would be inferred as INTEGER and rejected by the
...
def generate_launch_description() -> LaunchDescription:
    args = [
        ...
        DeclareLaunchArgument(
            ...
            "capacity here first, then offer udp_rate_fraction of it. "
            "0 = unlimited (floods). Only for protocol:=udp.",
        ),
        DeclareLaunchArgument(
