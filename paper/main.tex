...
\title{SCOOPS: A Holistic Multi-Agent Dataset for Sensing, Communication, Cooperative Perception, and SLAM\\
...
\textbf{S}LAM), a holistic multi-agent, multi-view, multi-sensor dataset
