...
\title{SCOOPS: A Holistic Multi-Agent Dataset for Sensing, Communication, Cooperative Perception, and Scene Reconstruction\\
...
\textbf{C}ommunication, c\textbf{OO}perative \textbf{P}erception, and
\textbf{S}cene reconstruction), a holistic multi-agent, multi-view,
