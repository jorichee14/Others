...
no axis to sweep.
*Roster:* 11 method configs, all loading and all validated against the streams
they declare. Six clear `run_method.py`'s preflight **today**
...
guessed, which is the refusal working rather than a gap.
